...
<main class="home no-pad">
  ...
  <section class="mandala-wrap" id="scene2">
    <div class="mandala">
      <a href="space" class="space"><div class="circle"><h3><span>Space</span></h3></div></a>
      ...
      <a href="water" class="water"><div class="circle"><h3><span>Water</span></h3></div></a>
    </div>
    <div class="mandala-circles" hidden>
      <div class="space">
  ...
  <a href="#ambient" id="audioCtl" class="sound-ctl stopped" on:click={controlMusic}></a>

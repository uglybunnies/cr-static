...
<main class="content-page bleed no-pad"  style="--grad-color: 255, 100%, 40%; --element-bg: linear-gradient(hsla(var(--grad-color), .3), hsla(255, 50%, 50%, .5)), url({base}/assets/space/voice-of-space-bg.webp) 0% 100%/100% auto fixed repeat; --element-mob-bg: url({base}/assets/space/voice-of-space-bg.webp) 0 0/auto 100vh scroll repeat; --element-color: 255, 90%, 80%; --subtitle-color: 255, 90%, 85%; --copy-color: var(--light-color);" >
  ...
  <section id="transcript" class="transcript-group">
    <div class="transcript-item">
      ...
      <div class="transcript" style="--transcript-bg: 80, 100%, 40%; --scrollbar-thumb-color: var(--light-color); --text-shadow: .0625em .0625em .0625em var(--dark-color-alpha3);">
        <p>Hallo. I am the guardian of space, and my name is Dhatvishvari. Our great mother space would like give a message to you now. Please listen.</p>
